...
class RefreshManager:
    ...
    def is_within_allowed_time(self, check_time: Optional[datetime] = None) -> Tuple[bool, Optional[str]]:
        """
        ...
        for allowed_time in self.allowed_refresh_times:
            ...
            window_start = self._subtract_minutes(allowed_time, self.auto_refresh_window // 2)
    ...
    def log_refresh(self, timestamp: Optional[datetime] = None, auto: bool = False):
        ...
        refresh_log = [
            entry for entry in refresh_log
