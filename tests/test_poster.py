...
class TestPosterTemplate:
    ...
    def test_template_initialization_with_defaults(self):
        ...
        template_data = {"name": "Test Template", "description": "Test description"}
    ...
    def test_template_initialization_with_custom_values(self):
        ...
        template_data = {
            ...
            "layout": {"width": 800, "height": 1600, "padding": 50},
    ...
    def test_template_from_file_valid_json(self):
        ...
        template_data = {"name": "File Template", "description": "Loaded from file"}
...
class TestPosterGenerator:
    ...
    def test_initialization_without_pil(self):
        ...
        with patch("moka_news.poster.generator.PIL_AVAILABLE", False):
            with pytest.raises(
                PosterGenerationError, match="Pillow library is required"
            ):
                PosterGenerator({})
    ...
    def test_load_nonexistent_template(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(
                PosterGenerationError, match="Template 'nonexistent' not found"
            ):
    ...
    def test_generate_local_poster_success(
        ...
        mock_gradient_img.split.return_value = [
            MagicMock(),
            MagicMock(),
            MagicMock(),
            MagicMock(),
        ...
        mock_box_img.split.return_value = [
            MagicMock(),
            MagicMock(),
            MagicMock(),
            MagicMock(),
...
properly when there are many sentences and words."""
    ...
    def test_wrap_text_functionality(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            text = (
                "This is a long sentence that should be wrapped across multiple lines"
            )
...
class TestContentBox:
    ...
    def test_rounded_box_with_shadow(self, mock_filter, mock_draw, mock_image):
        ...
        result = _draw_rounded_box_with_shadow(
            mock_base_img, (100, 100), (800, 1600), 20, shadow_config, "#ffffff"
        )
    ...
    def test_template_with_gradient_preset(self):
        ...
        template_data = {
            "name": "Preset Test",
            "gradient": {"enabled": True, "type": "vertical", "preset": "purple-pink"},
        }
    ...
    def test_template_backward_compatibility(self):
        ...
        template_data = {"name": "Old Template", "colors": {"background": "#000000"}}
...
class TestEnhancedPosterGeneration:
    ...
    def test_generate_poster_with_gradient_and_box(
        ...
        mock_rgba_img.split.return_value = [
            MagicMock(),
            MagicMock(),
            MagicMock(),
            MagicMock(),
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            editorial = {"title": "Test Editorial", "content": "Test content"}
    ...
    def test_custom_options_override_gradient(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            custom_options = {"gradient": {"colors": ["#00ff00", "#ff00ff"]}}
...
class TestPosterTextExtraction:
    ...
    def test_story_template_uses_two_line_title(self, tmp_path):
        ...
        config = {"method": "local", "default_template": "story"}
        gen = PosterGenerator(
            config, posters_dir=tmp_path, templates_dir=tmp_path / "templates"
        )
    ...
    def test_limit_wrapped_lines_caps_title_lines(self, tmp_path):
        ...
        text = (
            "Titolo lungo per verificare che il wrapping resti entro due righe massime"
        )
    ...
    def test_add_logo_skips_when_missing(self, tmp_path):
        ...
        result = gen._add_logo(
            img, template, draw_x=20, draw_y=20, max_width=300, total_draw_h=300
        )
